...
#define QNN_OP_CFG_VALID(opConfig) true

inline const char* getQnnOpConfigName(const Qnn_OpConfig_t& opConfig) { return opConfig.name; }
...
inline void setQnnOpConfigName(Qnn_OpConfig_t& opConfig, const char* name) { opConfig.name = name; }
...
inline void setQnnOpConfigPackageName(Qnn_OpConfig_t& opConfig, const char* packageName) {
  opConfig.packageName = packageName;
}
...
inline void setQnnOpConfigParams(Qnn_OpConfig_t& opConfig,
                                 uint32_t numOfParams,
                                 Qnn_Param_t* params) {
  opConfig.numOfParams = numOfParams;
...
inline void setQnnOpConfigInputs(Qnn_OpConfig_t& opConfig,
                                 uint32_t numOfInputs,
                                 Qnn_Tensor_t* inputTensors) {
  opConfig.numOfInputs  = numOfInputs;
  opConfig.inputTensors = inputTensors;
}
...
inline void setQnnOpConfigOutputs(Qnn_OpConfig_t& opConfig,
                                  uint32_t numOfOutputs,
                                  Qnn_Tensor_t* outputTensors) {
  opConfig.numOfOutputs  = numOfOutputs;
  opConfig.outputTensors = outputTensors;
}
...
inline uint32_t getQnnTensorId(const Qnn_Tensor_t& tensor) { return tensor.id; }
...
inline Qnn_TensorType_t getQnnTensorType(const Qnn_Tensor_t& tensor) { return tensor.type; }
...
inline Qnn_DataType_t getQnnTensorDataType(const Qnn_Tensor_t& tensor) { return tensor.dataType; }
...
inline uint32_t getQnnTensorRank(const Qnn_Tensor_t& tensor) { return tensor.rank; }

inline uint32_t getQnnTensorRank(const Qnn_Tensor_t* tensor) { return getQnnTensorRank(*tensor); }

inline uint32_t* getQnnTensorDimensions(const Qnn_Tensor_t& tensor) { return tensor.maxDimensions; }
...
inline void setQnnTensorId(Qnn_Tensor_t& tensor, uint32_t id) { tensor.id = id; }
...
inline void setQnnTensorType(Qnn_Tensor_t& tensor, Qnn_TensorType_t type) { tensor.type = type; }
...
inline void setQnnTensorRank(Qnn_Tensor_t& tensor, uint32_t rank) { tensor.rank = rank; }
...
inline void setQnnTensorDimensions(Qnn_Tensor_t& tensor, uint32_t* dims) {
  tensor.maxDimensions     = dims;
  tensor.currentDimensions = dims;
}
