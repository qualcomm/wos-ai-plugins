...
Download `stable-diffusion-webui-qairt-extension.zip` from the [latest release](https://github.com/qualcomm/wos-ai-plugins/releases/tag/v2.0-automatic1111-webgui).
